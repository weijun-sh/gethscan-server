...
```shell
git clone https://github.com/weijun-sh/gethscan-server.git
...
see more, please refer [config file example](https://github.com/weijun-sh/gethscan-server/blob/master/params/config-example.toml)
...
see more, please refer [token pair config file example](https://github.com/weijun-sh/gethscan-server/blob/master/params/config-tokenpair-example.toml)
...
For the config file, please refer [config file example](https://github.com/weijun-sh/gethscan-server/blob/master/params/config-example.toml)
...
5. config `[APIServer]` section
    ...
    Please see more here about [crossChain-Bridge-API](https://github.com/weijun-sh/gethscan-server/wiki/crossChain-Bridge-API)
